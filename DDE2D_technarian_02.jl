...
HHa=0.7    # Habitat enveloppe.  Basically max amount of x (bioenergy) that can be cointained by the habitat without running out of space.
...
# isoclines color ###############
plt1 = plot(layout=(1,1),size=(600,400),title="DDE2D_technarian, HHa=0.7")
...
#read(stdin, Char)
savefig("DDE2D_technarian_02_1")

plot!(plt1[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("DDE2D_technarian_02_1big")
...
#read(stdin, Char)
savefig("DDE2D_technarian_02_bw_1")

plot!(plt1[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("DDE2D_technarian_02_bw_1big")
...
u0 = [0.7, 1.0]; #Initial populations
tspan = (0.0,dur);
...
CSV.write("technarian02_ODE.csv",sol)
CSV.write("technarian02_SDE.csv",SDEsol)
...
#read(stdin, Char)
savefig("DDE2D_technarian_02_2")

plot!(plt1[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("DDE2D_technarian_02_2big")
...
#read(stdin, Char)
savefig("DDE2D_technarian_02_bw_2")

plot!(plt1[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("DDE2D_technarian_02_bw_2big")
...
plt2 = plot(layout=(1,1),title="DDE2D Technarian,HHa=0.7",size=(600,400))
...
#read(stdin, Char)
savefig("DDE2D_technarian_02_3")

plot!(plt2[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("DDE2D_technarian_02_3big")
...
#read(stdin, Char)
savefig("DDE2D_technarian_02_bw_3")

plot!(plt2[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("DDE2D_technarian_02_bw_3big")
