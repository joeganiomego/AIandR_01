...
"""
maximization of dpupu/dt and dTL/dt happens with polynomial beneficial effect from pupu and TL.
...
# pupu derivative with polynomial+exponential technical complexity
...
# pupu derivative with polynomial+stirling technical complexity
...
# paramp1[1] = general multiplier for pupu derivative with polynomial+exponential technical complexity
# paramp1[2] =*x[1]^(paramp1[2])* exponent for pupu factor of pupu derivative with polynomial+exponential technical complexity
# paramp1[3] = (x[2]^(paramp1[3])) exponent for GDPPC factor of pupu derivative with polynomial+exponential technical complexity
# paramp1[4] = *2^(x[2]*(paramp1[4])) exponent multiplier for GDPPC exponent of pupu derivative with polynomial+exponential technical complexity
# paramg1[1] = general multiplier for GDPPC derivative with polynomial+exponential technical complexity
# paramg1[2] =*x[1]^(paramp1[2])* exponent for pupu factor of GDPPC derivative with polynomial+exponential technical complexity
...
# pupu derivative with polynomial+exponential technical complexity + Popu density correction
...
# pupu derivative with polynomial+stirling technical complexity + Popu density correction
...
plot!(plt1[1],PopuGDPPCsol1.t,PopuGDPPCsol1[1,:],linewidth=1,color=:black,linestyle=:solid,label="Model 1")
plot!(plt1[1],PopuGDPPCsol1b.t,PopuGDPPCsol1b[1,:],linewidth=1,color=:black,linestyle=:solid,primary=false )

plot!(plt1[1],PopuGDPPCsol2.t,PopuGDPPCsol2[1,:],linewidth=1,color=:black,linestyle=:dashdotdot,label="Model 2")
plot!(plt1[1],PopuGDPPCsol2b.t,PopuGDPPCsol2b[1,:],linewidth=1,color=:black,linestyle=:dashdotdot,primary=false )
...
plot!(plt1[1],PopuGDPPCsol3.t,PopuGDPPCsol3[1,:],linewidth=1,color=:black,linestyle=:dot,label="Model 3")
plot!(plt1[1],PopuGDPPCsol3b.t,PopuGDPPCsol3b[1,:],linewidth=1,color=:black,linestyle=:dot,primary=false )

plot!(plt1[1],PopuGDPPCsol4.t,PopuGDPPCsol4[1,:],linewidth=1,color=:black,linestyle=:dashdot,label="Model 4")
plot!(plt1[1],PopuGDPPCsol4b.t,PopuGDPPCsol4b[1,:],linewidth=1,color=:black,linestyle=:dashdot,primary=false )

###################
# Plot DDE from manually estimated parameters
# Popu

plot!(plt1[1],PopuGDPPCsol5.t,PopuGDPPCsol5[1,:],linewidth=1,color=:black,linestyle=:dash,label="Model 5")
plot!(plt1[1],PopuGDPPCsol5b.t,PopuGDPPCsol5b[1,:],linewidth=1,color=:black,linestyle=:dash,primary=false )

plot!(plt1[1],PopuGDPPCsol6.t,PopuGDPPCsol6[1,:],linewidth=1,color=:black,linestyle=:solid,label="Model 6")
plot!(plt1[1],PopuGDPPCsol6b.t,PopuGDPPCsol6b[1,:],linewidth=1,color=:black,linestyle=:solid,primary=false ,
...
#read(stdin, Char)
savefig("Population_Norm_01_bw_1")

plot!(plt1[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("Population_Norm_01_bw_1big")
...
#read(stdin, Char)
savefig("Population_Norm_01_bw_1focus")
...
plot!(plt2[1],PopuGDPPCsol1.t,PopuGDPPCsol1[1,:]*Popu[1],linewidth=1,color=:black,linestyle=:solid,label="Model 1")
plot!(plt2[1],PopuGDPPCsol1b.t,PopuGDPPCsol1b[1,:]*Popu[1],linewidth=1,color=:black,linestyle=:solid,primary=false)

plot!(plt2[1],PopuGDPPCsol2.t,PopuGDPPCsol2[1,:]*Popu[1],linewidth=1,color=:black,linestyle=:dashdotdot,label="Model 2")
plot!(plt2[1],PopuGDPPCsol2b.t,PopuGDPPCsol2b[1,:]*Popu[1],linewidth=1,color=:black,linestyle=:dashdotdot,primary=false)
...
plot!(plt2[1],PopuGDPPCsol3.t,PopuGDPPCsol3[1,:]*Popu[1],linewidth=1,color=:black,linestyle=:dot,label="Model 3")
plot!(plt2[1],PopuGDPPCsol3b.t,PopuGDPPCsol3b[1,:]*Popu[1],linewidth=1,color=:black,linestyle=:dot,primary=false)

plot!(plt2[1],PopuGDPPCsol4.t,PopuGDPPCsol4[1,:]*Popu[1],linewidth=1,color=:black,linestyle=:dashdot,label="Model 4")
plot!(plt2[1],PopuGDPPCsol4b.t,PopuGDPPCsol4b[1,:]*Popu[1],linewidth=1,color=:black,linestyle=:dashdot,primary=false)

###################
# Plot DDE from manually estimated parameters
# Popu

plot!(plt2[1],PopuGDPPCsol5.t,PopuGDPPCsol5[1,:]*Popu[1],linewidth=1,color=:black,linestyle=:dash,label="Model 5")
plot!(plt2[1],PopuGDPPCsol5b.t,PopuGDPPCsol5b[1,:]*Popu[1],linewidth=1,color=:black,linestyle=:dash,primary=false)

plot!(plt2[1],PopuGDPPCsol6.t,PopuGDPPCsol6[1,:]*Popu[1],linewidth=1,color=:black,linestyle=:solid,label="Model 6")
plot!(plt2[1],PopuGDPPCsol6b.t,PopuGDPPCsol6b[1,:]*Popu[1],linewidth=1,color=:black,linestyle=:solid,primary=false,
...
#read(stdin, Char)
savefig("Population_Real_01_bw_1")

plot!(plt2[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("Population_Real_01_bw_1big")
...
#read(stdin, Char)
savefig("Population_Real_01_bw_1focus")
...
plot!(plt3[1],PopuGDPPCsol1.t,PopuGDPPCsol1[2,:],linewidth=1,color=:black,linestyle=:solid,label="Model 1")
plot!(plt3[1],PopuGDPPCsol1b.t,PopuGDPPCsol1b[2,:],linewidth=1,color=:black,linestyle=:solid,primary=false)

plot!(plt3[1],PopuGDPPCsol2.t,PopuGDPPCsol2[2,:],linewidth=1,color=:black,linestyle=:dashdotdot,label="Model 2")
plot!(plt3[1],PopuGDPPCsol2b.t,PopuGDPPCsol2b[2,:],linewidth=1,color=:black,linestyle=:dashdotdot,primary=false)
...
plot!(plt3[1],PopuGDPPCsol3.t,PopuGDPPCsol3[2,:],linewidth=1,color=:black,linestyle=:dot,label="Model 3")
plot!(plt3[1],PopuGDPPCsol3b.t,PopuGDPPCsol3b[2,:],linewidth=1,color=:black,linestyle=:dot,primary=false)

plot!(plt3[1],PopuGDPPCsol4.t,PopuGDPPCsol4[2,:],linewidth=1,color=:black,linestyle=:dashdot,label="Model 4")
plot!(plt3[1],PopuGDPPCsol4b.t,PopuGDPPCsol4b[2,:],linewidth=1,color=:black,linestyle=:dashdot,primary=false)
...
plot!(plt3[1],PopuGDPPCsol5.t,PopuGDPPCsol5[2,:],linewidth=1,color=:black,linestyle=:dash,label="Model 5")
plot!(plt3[1],PopuGDPPCsol5b.t,PopuGDPPCsol5b[2,:],linewidth=1,color=:black,linestyle=:dash,primary=false)

plot!(plt3[1],PopuGDPPCsol6.t,PopuGDPPCsol6[2,:],linewidth=1,color=:black,linestyle=:solid,label="Model 6")
plot!(plt3[1],PopuGDPPCsol6b.t,PopuGDPPCsol6b[2,:],linewidth=1,color=:black,linestyle=:solid,primary=false,
...
#read(stdin, Char)
savefig("TechLevel_01_bw_1")

plot!(plt3[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("TechLevel_01_bw_1big")
...
#read(stdin, Char)
savefig("TechLevel_01_bw_1focus")
...
# Scatter input data
scatter!(plt4[1],year[1:19],(LEB[1:19]),color=:black,label="Historic LEB")
...
plot!(plt4[1],PopuGDPPCsol5.t,Leb5,linewidth=1,color=:black,linestyle=:dash, label="LEB model5")
plot!(plt4[1],PopuGDPPCsol5b.t,Leb5b,linewidth=1,color=:black,linestyle=:dash,primary=false)
plot!(plt4[1],PopuGDPPCsol5.t,Hle5,linewidth=1,color=:black,linestyle=:dash, label="HLE model5")
plot!(plt4[1],PopuGDPPCsol5b.t,Hle5b,linewidth=1,color=:black,linestyle=:dash,primary=false)
plot!(plt4[1],PopuGDPPCsol5.t,Eta5,linewidth=1,color=:black,linestyle=:dash, label="ETA model5")
plot!(plt4[1],PopuGDPPCsol5b.t,Eta5b,linewidth=1,color=:black,linestyle=:dash,primary=false)

plot!(plt4[1],PopuGDPPCsol6.t,Leb6,linewidth=1,color=:black,linestyle=:solid,label="LEB model6")
plot!(plt4[1],PopuGDPPCsol6b.t,Leb6b,linewidth=1,color=:black,linestyle=:solid,primary=false)
plot!(plt4[1],PopuGDPPCsol6.t,Hle6,linewidth=1,color=:black,linestyle=:solid,label="HLE model6")
plot!(plt4[1],PopuGDPPCsol6b.t,Hle6b,linewidth=1,color=:black,linestyle=:solid,primary=false)
plot!(plt4[1],PopuGDPPCsol6.t,Eta6,linewidth=1,color=:black,linestyle=:solid,label="ETA model6")
plot!(plt4[1],PopuGDPPCsol6b.t,Eta6b,linewidth=1,color=:black,linestyle=:solid,primary=false,
...
#read(stdin, Char)
savefig("LEB_HLE_ETA_01_bw_1big")
...
#read(stdin, Char)
savefig("LEB_HLE_ETA_01_bw_1focus")
...
plot!(plt5[1],(PopuGDPPCsol5[2,:]),(PopuGDPPCsol5[1,:]),linewidth=2,color=:black,linestyle=:dash,label="Model 5 Future" )
plot!(plt5[1],(PopuGDPPCsol5b[2,:]),(PopuGDPPCsol5b[1,:]),linewidth=5,color=:black,linestyle=:dash,label="Model 5 Past" )

plot!(plt5[1],(PopuGDPPCsol6[2,:]),(PopuGDPPCsol6[1,:]),linewidth=2,color=:black,linestyle=:solid,label="Model 6 Future")
plot!(plt5[1],(PopuGDPPCsol6b[2,:]),(PopuGDPPCsol6b[1,:]),linewidth=4,color=:black,linestyle=:solid,label="Model 6 Past" ,
...
#read(stdin, Char)
savefig("FunctionalResponse_01_bw_1")

plot!(plt5[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("FunctionalResponse_01_bw_1big")
...
plot!(plt6[1],sx,(derivative(spl_Technarian_p, sx; nu=1)),linewidth=1,color=:black,linestyle=:solid, label="Historic Population Spline")
plot!(plt6[1],sxx,(derivative(spl_Pre_Technarian_p, sxx; nu=1)),linewidth=1,color=:black,linestyle=:solid,label="Historic Population Straight")

plot!(plt6[1],(sd),(multimodelp1(xdata, paramp1)),linewidth=1,color=:black,linestyle=:dash, label="Population LsqFit Exponential (model1)")
plot!(plt6[1],(sd),(multimodelp2(xdata, paramp2)),linewidth=1,color=:black,linestyle=:dot, label="Population LsqFit Stirling (model2)",
...
#read(stdin, Char)
savefig("PupulationDerivatives_01_bw_1")

plot!(plt6[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("PupulationDerivatives_01_bw_1big")

#######

plt7 = plot(layout=(1,1),title="Technical Level Derivative and LsqFit",size=(600,400))

plot!(plt7[1],sx,(derivative(spl_Technarian_g, sx; nu=1)),linewidth=1,color=:black,linestyle=:solid, label="Historic Tech Level Spline")
plot!(plt7[1],sxx,(derivative(spl_Pre_Technarian_g, sxx; nu=1)),linewidth=1,color=:black,linestyle=:solid, label="Historic Tech Level Straight")

plot!(plt7[1],(sd),(multimodelg1(xdata, paramg1)),linewidth=1,color=:black,linestyle=:dash, label="Tech Level LsqFit Exponential (model1)")
plot!(plt7[1],(sd),(multimodelg2(xdata, paramg2)),linewidth=1,color=:black,linestyle=:dot, label="Tech Level LsqFit Stirling (model2)",
xaxis="[CE years]",yaxis="[Derivative of Tech Level]",xticks = year[9]:(floor(year[19]/40)):year[19],
# yticks = 0.0:20:120, xlims = (0.5,1.5),ylims = (0.5,1.5),
legend=:topleft,grid= false,show = true)

#read(stdin, Char)
savefig("TLDerivatives_01_bw_1")

plot!(plt7[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("TLDerivatives_01_bw_1big")
...
color=:black,linestyle=:solid, label="Historic Spline")
plot!(plt8[1],((derivative(spl_Pre_Technarian_g, sxx; nu=1)),(derivative(spl_Pre_Technarian_p, sxx; nu=1))),linewidth=1,
color=:black,linestyle=:dashdotdot, label="Historic Straight")

plot!(plt8[1],(dG3dt,dP3dt),linewidth=1,color=:black,linestyle=:dot, label="Model 3")
plot!(plt8[1],(dG3bdt,dP3bdt),linewidth=3,color=:black,linestyle=:dot,primary=false)
plot!(plt8[1],(dG4dt,dP4dt),linewidth=1,color=:black,linestyle=:dashdot, label="Model 4")
plot!(plt8[1],(dG4bdt,dP4bdt),linewidth=3,color=:black,linestyle=:dashdot,primary=false)
plot!(plt8[1],(dG5dt,dP5dt),linewidth=1,color=:black,linestyle=:dash, label="Model 5")
plot!(plt8[1],(dG5bdt,dP5bdt),linewidth=4,color=:black,linestyle=:dash,primary=false)
plot!(plt8[1],(dG6dt,dP6dt),linewidth=1,color=:black,linestyle=:solid, label="Model 6")
plot!(plt8[1],(dG6bdt,dP6bdt),linewidth=3,color=:black,linestyle=:solid,primary=false,
xaxis="Technical Level Derivative",yaxis="Population_Normalized Derivative",
#xticks = -2000:(floor(6000/20)):6000,yticks = 0.0:20:120,xlims = (0.5,1.5),ylims = (0.5,1.5),
legend=:bottomright,show = true)

#read(stdin, Char)
savefig("DerivativesLoop_01_bw_1")

plot!(plt8[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("DerivativesLoop_01_bw_1big")
...
plot!(plt9[1],(GrowthTL5,GrowthP5),linewidth=1,color=:black,linestyle=:dash, label="Model 5")
plot!(plt9[1],(GrowthTL5b,GrowthP5b),linewidth=3,color=:black,linestyle=:dash,primary=false)
plot!(plt9[1],(GrowthTL6,GrowthP6),linewidth=1,color=:black,linestyle=:solid, label="Model 6")
plot!(plt9[1],(GrowthTL6b,GrowthP6b),linewidth=3,color=:black,linestyle=:solid,primary=false,
xaxis="Technical Level % Growth",yaxis="Population % Growth",
#xticks = -2000:(floor(6000/20)):6000,yticks = 0.0:20:120,xlims = (0.5,1.5),ylims = (0.5,1.5),
legend=:bottomright,show = true)

#read(stdin, Char)
savefig("GrowthLoop_01_bw_1")

plot!(plt9[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("GrowthLoop_01_bw_1big")
...
plot!(plt10[1],(sx),(derivative(spl_Technarian_p, sx; nu=1)),linewidth=1,color=:black,linestyle=:dot, label="Population Spline")
plot!(plt10[1],sx,(derivative(spl_Technarian_g, sx; nu=1)),linewidth=1,color=:black,linestyle=:dot, label="Technical Level Spline")

plot!(plt10[1],saved_values5.t[2:end],(dP5dt),linewidth=1,color=:black,linestyle=:dash, label="Model5 Population Derivative")
plot!(plt10[1],saved_values5b.t[2:end],(dP5bdt),linewidth=4,color=:black,linestyle=:dash,primary=false)
plot!(plt10[1],saved_values6.t[2:end],(dP6dt),linewidth=1,color=:black,linestyle=:solid, label="Model6 Population Derivative")
plot!(plt10[1],saved_values6b.t[2:end],(dP6bdt),linewidth=3,color=:black,linestyle=:solid,primary=false)

plot!(plt10[1],saved_values5.t[2:end],(dG5dt),linewidth=1,color=:black,linestyle=:dash, label="Model5 Tech Level Derivative")
plot!(plt10[1],saved_values5b.t[2:end],(dG5bdt),linewidth=4,color=:black,linestyle=:dash,primary=false)
plot!(plt10[1],saved_values6.t[2:end],(dG6dt),linewidth=1,color=:black,linestyle=:solid, label="Model6 Tech Level Derivative")
plot!(plt10[1],saved_values6b.t[2:end],(dG6bdt),linewidth=3,color=:black,linestyle=:solid,primary=false,
...
#read(stdin, Char)
savefig("TheSwitch_01_bw_1focus")
...
#read(stdin, Char)
savefig("TheSwitch_01_bw_1superfocus")
...
plot!(plt11[1],saved_values5.t[1:end],GrowthP5,linewidth=1,color=:black,linestyle=:dash, label="Model5 Population %Growth")
plot!(plt11[1],saved_values5b.t[1:end],GrowthP5b,linewidth=4,color=:black,linestyle=:dash,primary=false)
plot!(plt11[1],saved_values6.t[1:end],GrowthP6,linewidth=1,color=:black,linestyle=:solid, label="Model6 Population %Growth")
plot!(plt11[1],saved_values6b.t[1:end],GrowthP6b,linewidth=3,color=:black,linestyle=:solid,primary=false)
plot!(plt11[1],saved_values5.t[1:end],GrowthTL5,linewidth=1,color=:black,linestyle=:dash, label="Model5 Tech Level %Growth")
plot!(plt11[1],saved_values5b.t[1:end],GrowthTL5b,linewidth=4,color=:black,linestyle=:dash,primary=false)
plot!(plt11[1],saved_values6.t[1:end],GrowthTL6,linewidth=1,color=:black,linestyle=:solid, label="Model6 Tech Level %Growth")
plot!(plt11[1],saved_values6b.t[1:end],GrowthTL6b,linewidth=3,color=:black,linestyle=:solid,primary=false,
...
#read(stdin, Char)
savefig("TheSwitchGrowth_01_bw_1")
...
#read(stdin, Char)
savefig("TheSwitchGrowth_01_bw_1big")
...
#read(stdin, Char)
savefig("TheSwitchGrowth_01_bw_1focus")

# plot superfocus 

plot!(plt11[1],RealUNpopuGRyears,RealUNpopuGrowthRate,linewidth=3,color=:black,linestyle=:solid, label="RealUNpopuGrowthRate")
plot!(plt11[1],EstimatesUNpopuGRyears,EstimatesUNpopuGrowthRate,linewidth=1,color=:black,linestyle=:solid,label="EstimatesUNpopuGrowthRate")

plot!(plt11[1],WorldBankGDPyears,WorldBankGDPPCrate,linewidth=1,color=:black,linestyle=:dot, label="WorldBankGDPPCrate")
...
#read(stdin, Char)
savefig("TheSwitchGrowth_01_bw_1superfocus")
...
plot!(plt12[1],saved_values5.t[1:end],GrowthGDP5,linewidth=1,color=:black,linestyle=:dash, label="Model5 Tech Level GDP %Growth")
plot!(plt12[1],saved_values5b.t[1:end],GrowthGDP5b,linewidth=4,color=:black,linestyle=:dash,primary=false)
plot!(plt12[1],saved_values6.t[1:end],GrowthGDP6,linewidth=1,color=:black,linestyle=:solid, label="Model6 Tech Level GDP %Growth")
plot!(plt12[1],saved_values6b.t[1:end],GrowthGDP6b,linewidth=3,color=:black,linestyle=:solid,primary=false,
...
#read(stdin, Char)
savefig("TheSwitchGDPGrowth_01_bw_1")

plot!(plt12[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("TheSwitchGDPGrowth_01_bw_1big")
...
#read(stdin, Char)
savefig("TheSwitchGDPGrowth_01_bw_1focus")

# plot superfocus
plot!(plt12[1],WorldBankGDPyears,WorldBankGDPrate,linewidth=1,color=:black,linestyle=:dot, label="WorldBankGDPrate")
...
#read(stdin, Char)
savefig("TheSwitchGDPGrowth_01_bw_1superfocus")
...
#read(stdin, Char)
savefig("TheSwitchGDPGrowth_01_bw_2superfocus")
...
plot!(plt13[1],saved_values5.t[1:end],GrowthP5,linewidth=1,color=:black,linestyle=:dash, label="Model5 Population %Growth")
plot!(plt13[1],saved_values5b.t[1:end],GrowthP5b,linewidth=4,color=:black,linestyle=:dash,primary=false)
plot!(plt13[1],saved_values6.t[1:end],GrowthP6,linewidth=1,color=:black,linestyle=:solid, label="Model6 Population %Growth")
plot!(plt13[1],saved_values6b.t[1:end],GrowthP6b,linewidth=3,color=:black,linestyle=:solid,primary=false,
...
#read(stdin, Char)
savefig("TheSwitchPopulationGrowth_01_bw_1")
...
#read(stdin, Char)
savefig("TheSwitchPopulationGrowth_01_bw_1big")
...
#read(stdin, Char)
savefig("TheSwitchPopulationGrowth_01_bw_1focus")

# plot superfocus 

plot!(plt13[1],RealUNpopuGRyears,RealUNpopuGrowthRate,linewidth=3,color=:black,linestyle=:dot, label="RealUNpopuGrowthRate")
plot!(plt13[1],EstimatesUNpopuGRyears,EstimatesUNpopuGrowthRate,linewidth=1,color=:black,linestyle=:dot,label="EstimatesUNpopuGrowthRate")
...
#read(stdin, Char)
savefig("TheSwitchPopulationGrowth_01_bw_1superfocus")
...
plot!(plt14[1],saved_values5.t[1:end],GrowthTL5,linewidth=1,color=:black,linestyle=:dash, label="Model5 Tech Level %Growth")
plot!(plt14[1],saved_values5b.t[1:end],GrowthTL5b,linewidth=4,color=:black,linestyle=:dash,primary=false)
plot!(plt14[1],saved_values6.t[1:end],GrowthTL6,linewidth=1,color=:black,linestyle=:solid, label="Model6 Tech Level %Growth")
plot!(plt14[1],saved_values6b.t[1:end],GrowthTL6b,linewidth=3,color=:black,linestyle=:solid,primary=false,
...
#read(stdin, Char)
savefig("TheSwitchTECHLEVELGrowth_01_bw_1")
...
#read(stdin, Char)
savefig("TheSwitchTECHLEVELGrowth_01_bw_1big")
...
#read(stdin, Char)
savefig("TheSwitchTECHLEVELGrowth_01_bw_1focus")

# plot superfocus 


plot!(plt14[1],WorldBankGDPyears,WorldBankGDPPCrate,linewidth=1,color=:black,linestyle=:dot, label="WorldBankGDPPCrate")
...
#read(stdin, Char)
savefig("TheSwitchTECHLEVELGrowth_01_bw_1superfocus")
